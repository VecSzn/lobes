...
# https://github.com/LiveCodeBench/LiveCodeBench  (MIT, see LICENSE next to this file)
# Fetched 2026-09-17. The only change is this header; signal.alarm is shimmed by the caller on Windows.
import ast
import json
import sys
import faulthandler
