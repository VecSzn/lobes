...
批次组成变了浮点归约就变，同一个种子并不锁死同一串 token。逐题的分析、证人的统计和
预注册假设的核对（八条里四条不成立）都在 [eval/REPORT.md](eval/REPORT.md)；规则在跑
之前就写死在 [eval/PREREG.md](eval/PREREG.md) 和 [eval/PREREG-v3.md](eval/PREREG-v3.md)。
